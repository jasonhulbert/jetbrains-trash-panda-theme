" Name:			Trash Panda Theme (High Contrast)
...
let g:colors_name= 'trashpanda-high'
...
hi Normal guifg=#c2c9cf guibg=#080a0a gui=NONE cterm=NONE
hi ColorColumn guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi CursorColumn guifg=NONE guibg=#1296de gui=NONE cterm=NONE
hi CursorLine guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi CursorLineNr guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi Folded guifg=#B5B6E3 guibg=#3e4d58 gui=NONE cterm=NONE
hi QuickFixLine guifg=#094b6f guibg=NONE gui=NONE cterm=NONE
hi Conceal guifg=NONE guibg=#3e4d58 gui=NONE cterm=NONE
hi Cursor guifg=#080a0a guibg=#79c1f5 gui=NONE cterm=NONE
hi Directory guifg=#1296de guibg=#080a0a gui=NONE cterm=NONE
hi EndOfBuffer guifg=#c2c9cf guibg=#080a0a gui=NONE cterm=NONE
hi ErrorMsg guifg=#f44034 guibg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=NONE guibg=#5f707c gui=NONE cterm=NONE
hi LineNr guifg=#3e4d58 guibg=NONE gui=NONE cterm=NONE
hi MatchParen guifg=#FFFFFF guibg=#79c1f5 gui=NONE cterm=NONE
hi ModeMsg guifg=#080a0a guibg=#05c895 gui=NONE cterm=NONE
hi MoreMsg guifg=#03644b guibg=NONE gui=NONE cterm=NONE
hi NonText guifg=#c2c9cf guibg=#080a0a gui=NONE cterm=NONE
hi PMenu guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi PMenuSbar guifg=NONE guibg=#3e4d58 gui=NONE cterm=NONE
hi PMenuSel guifg=#080a0a guibg=#05c895 gui=NONE cterm=NONE
hi PMenuThumb guifg=NONE guibg=#05c895 gui=NONE cterm=NONE
hi Question guifg=#f44034 guibg=#5f707c gui=NONE cterm=NONE
hi Search guifg=#c2c9cf guibg=#094b6f gui=NONE cterm=NONE
hi SignColumn guifg=#3e4d58 guibg=#FFFFFF gui=NONE cterm=NONE
hi SpecialKey guifg=#6f6930 guibg=NONE gui=NONE cterm=NONE
...
hi StatusLine guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi StatusLineNC guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi TabLine guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi TabLineFill guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi TabLineSel guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi Title guifg=#03644b guibg=#080a0a gui=NONE cterm=NONE
hi VertSplit guifg=#3e4d58 guibg=#080a0a gui=NONE cterm=NONE
hi Visual guifg=#79c1f5 guibg=#1e303d gui=NONE cterm=NONE
hi VisualNOS guifg=#79c1f5 guibg=#1e303d gui=NONE cterm=NONE
hi WarningMsg guifg=#f44034 guibg=#3d100d gui=NONE cterm=NONE
hi WildMenu guifg=#05c895 guibg=#080a0a gui=NONE cterm=NONE
hi Comment guifg=#6f8491 guibg=NONE gui=NONE cterm=NONE
hi Constant guifg=#c2c9cf guibg=NONE gui=NONE cterm=NONE
hi Error guifg=#3d100d guibg=#f44034 gui=NONE cterm=NONE
hi Identifier guifg=#c2c9cf guibg=NONE gui=NONE cterm=NONE
hi Ignore guifg=#686A4E guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#ded15f guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#03644b guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#bd7df8 guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#79c1f5 guibg=#1e303d gui=NONE cterm=NONE
hi Type guifg=#9cc46e guibg=NONE gui=NONE cterm=NONE
hi Underline guifg=#f44034 guibg=NONE gui=bold,underline cterm=underline
...
hi DiffAdd guifg=#05c895 guibg=NONE gui=NONE cterm=NONE
hi DiffChange guifg=#f8a54c guibg=NONE gui=NONE cterm=NONE
hi DiffText guifg=#c2c9cf guibg=NONE gui=NONE cterm=NONE
hi DiffDelete guifg=#f44034 guibg=NONE gui=NONE cterm=NONE
